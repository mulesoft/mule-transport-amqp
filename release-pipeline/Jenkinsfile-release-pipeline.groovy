...
properties([
        parameters([
                string(name: 'repo_branch_from_param', defaultValue: '3.9.x', description: '''The branch from the release is going to be done. <b>IMPORTANT</b> doing the release from the "master" branch is not supported.
